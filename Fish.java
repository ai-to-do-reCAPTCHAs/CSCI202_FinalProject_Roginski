...
class Fish extends Animal {
    ...
    public Fish(String[] tokens) throws ParseException {
        super(Integer.parseInt(tokens[1]), tokens[2], Integer.parseInt(tokens[3]), tokens[4].charAt(0), false, tokens[5]);
        this.type = tokens[6];
        this.color = tokens[7];
    }
    ...
    public String toText() {
        return ("Fish\t" + this.getChipID() + "\t" + this.getName() + "\t" + this.getAge() + "\t" + this.getGender() + "\t" + this.getOwner() + "\t" + this.getType() + "\t" + this.getColor());
    }
}
